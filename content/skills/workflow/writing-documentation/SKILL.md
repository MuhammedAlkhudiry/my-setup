...
- Check facts before editing. Give each fact or instruction one authoritative source. Link to that source elsewhere, and mark claims you cannot verify
  as unresolved.
- Link to the authoritative source instead of copying details the agent can look up.
...
- Keep lasting decisions, important limits, guidance that is not obvious, and clear completion criteria. Remove obvious examples and repeated details.
